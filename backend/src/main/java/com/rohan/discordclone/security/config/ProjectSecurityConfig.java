...
//					config.setAllowedOrigins(Collections.singletonList("https://chatbuzz-rohan-patel.vercel.app"));
					config.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://chatbuzz.netlify.app", "https://chatbuzz-rohan-patel.vercel.app"));
