...
public class SocketMessagingService {
	...
	public String addDirectMessage(String convoId, String authorId, String authorUsername, String content) {

		String messageId = UUID.randomUUID().toString();
		Message message = new Message(convoId, messageId, authorId, authorUsername, content, LocalDateTime.now().toString(), "DIRECT");
...
//		System.out.println();
	...
	public String addConversation(String authorId, String authorUsername, String content, String receiverId) {
		...
		String messageId = addDirectMessage(conversationId, authorId, authorUsername, content);
...
//			List<String> messageIds = convo.getMessages();
			...
			List<Message> loadedMessages = messageRepo.findAllByConversationId(convoId);
